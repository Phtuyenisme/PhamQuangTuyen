...
ToggleButton.Parent = game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui") -- Đặt ngoài UI chính
...
ToggleButton.Image = "rbxassetid://140362506923219" -- Thay YOUR_IMAGE_ID bằng ID ảnh của bạn
